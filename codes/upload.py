...
class Ui_Upload(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "Tipo de Arquivo"))
        self.comboBox.setItemText(0, _translate("Form", "Documento"))
        self.comboBox.setItemText(1, _translate("Form", "Imagem"))
        self.comboBox.setItemText(2, _translate("Form", "Musica"))
        self.comboBox.setItemText(3, _translate("Form", "Video"))
        self.comboBox.setItemText(4, _translate("Form", "Outro"))
